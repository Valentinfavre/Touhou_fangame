 ...
 * File :input.cpp
 * Description:Toutes les commande et leurs effets sont stocké dans cette source cpp, tout les effets sont listé par
 * leurs nom comme nature de leurs utilisations.
 *
 */
#include <set>
