 ...
 * File :data.cpp
 * Description:Tentative cité dans les options de faire un systéme de sauvegarde des paramétres (non fonctionel)
 *
 */
...
std::ostream &operator<<(std::ostream &o, const Options &opt) {
    o << "# Accéder au game.conf pour effectuer des modifications visuels !"
